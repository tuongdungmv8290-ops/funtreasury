...
import { Copy, X, ArrowRight, Link, FileText } from 'lucide-react';
          ...
          <div className="relative z-10 bg-background rounded-t-2xl -mt-4 px-6 py-5 space-y-4">
            ...
            <div className="flex gap-2 pt-1">
              <Button variant="outline" className="flex-1 gap-2" onClick={copyLink}>
                <Link className="w-4 h-4" /> Sao chép
              </Button>
              <Button variant="outline" className="gap-2" onClick={() => setShowReceipt(true)}>
